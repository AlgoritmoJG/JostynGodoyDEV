<h1 align="center">Hi ,Soy Jostyn Godoy <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
<p align="center"> 
	<img src="https://komarev.com/ghpvc/?username=AlgoritmoJG&label=Profile%20views&color=0047AB&style=plastic?" alt="AlgoritmoJG" height=25px, width=160px/> 
	<!---
...
## <picture><img src = "https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/about_me.gif?raw=true" width = 50px></picture> Bienvenido

<picture> <img align="right" src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Right_Side.gif?raw=true" width = 250px></picture>

<br><br>

- :school: I am a `Junior` at Faculta de Ingenieria en Sistemas en Universidad Mariano Galvez De Guatemala.
- :trophy: .
- :technologist: Me encanta usar el software como solución para cada `Problema`.
- :computer: Soy programador competitivo en `Codeforces`, `Atcoder`, `Leetcode`, `Codechef`, `Google Contests`.
- :student: actualmente estoy aprendiendo `Ciencias de la Computacion` e `Ingenieria en Sistemas`.
- :nerd_face: Siempre`aprendiendo nuevas cosas`.
- :thinking: Actualmente estoy abierto para un nuevo`oportunidad de trabajo`.
- :boom: .
<br>
